...
class PresentationMode:
    ...
    def activate(self):
        ...
        try:
            ...
            subprocess.run(
                ["powershell", "-Command",
                 "Set-ItemProperty -Path 'HKCU:\\Software\\Microsoft\\Windows\\CurrentVersion\\Notifications\\Settings' -Name 'NOCGlobalSettingToastsEnabled' -Value 0 -Type DWord -Force"],
