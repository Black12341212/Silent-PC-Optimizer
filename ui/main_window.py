...
from core.disk_optimizer import optimize_drive, get_disk_health, get_disk_drives, is_ssd
from core.system_monitor import get_network_processes
...
from core.update_manager import get_windows_updates, get_update_settings
...
class MainWindow:
    def __init__(self, root, app_state, theme_manager):
        ...
        self.root.title("Silent PC Optimizer v4.0")
    ...
    def _build_ui(self):
        ...
        tab_names = [
            ...
            ("game_mode", "Game Mode"), ("history", "History"),
    ...
    def _clean_recycle(self):
        try:
            import subprocess
            subprocess.run(["rd", "/s", "/q", "C:\\$Recycle.Bin"], capture_output=True, timeout=30)
    ...
    def _build_about(self, parent):
        ...
        tk.Label(center, text="v4.0", bg=bg, fg=accent,
